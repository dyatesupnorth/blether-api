...
class User extends SmartLoquent implements UserInterface, RemindableInterface
{
    ...
    public static function getForgotRules()
    {
        return self::$forgotRules;
    }

    public static function getResetRules()
    {
        return self::$resetRules;
    }
    ...
    public function feedPosts() {
        return $this->hasManyThrough('Blether', 'Friend');
    }
